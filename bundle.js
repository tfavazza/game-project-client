...
/***/ function(module, exports, __webpack_require__) {
	...
	var showGames = function showGames() {
	  //showGames GET	/games	games#index
	  return $.ajax({
	    url: app.host + '/games',
	    method: 'GET',
	    headers: {
	...
	var getGameById = function getGameById(id) {
	  //getGameById GET	/games/:id	games#show
	  return $.ajax({
	...
	var getAllGamesPlayed = function getAllGamesPlayed() {
	  return $.ajax({
	    url: app.host + '/games/',
	    method: 'GET',
	    headers: {
	...
	module.exports = {
	  ...
	  getAllGamesPlayed: getAllGamesPlayed
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  getButtonNumber: getButtonNumber,
